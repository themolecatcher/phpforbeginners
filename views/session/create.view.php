...
<main>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div>
            ...
            <div class="mt-2">
            <input id="email" name="email" type="email" autocomplete="email" placeholder="Email address" value=" <?=  old($email) ?>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
        </div>

        <?php if (isset($errors['email'])) : ?>
                        <p class="text-red-500 mt-5"><?= $errors['email'] ?></p> 
        <?php endif; ?>    
        ...
        <?php if (isset($errors['password'])) : ?>
                        <p class="text-red-500 mt-5"><?= $errors['password'] ?></p> 
        <?php endif; ?>    
